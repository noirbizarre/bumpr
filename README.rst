...
.. image:: https://secure.travis-ci.org/noirbizarre/bumpr.svg?tag=0.3.1
    :target: https://travis-ci.org/noirbizarre/bumpr
    :alt: Build status
.. image:: https://coveralls.io/repos/noirbizarre/bumpr/badge.svg?tag=0.3.1
    :target: https://coveralls.io/r/noirbizarre/bumpr?tag=0.3.1
    :alt: Code coverage
.. image:: https://requires.io/github/noirbizarre/bumpr/requirements.svg?tag=0.3.1
    :target: https://requires.io/github/noirbizarre/bumpr/requirements/?tag=0.3.1
    :alt: Requirements Status
.. image:: https://readthedocs.org/projects/bumpr/badge/?version=0.3.1
    :target: https://bumpr.readthedocs.io/en/0.3.1/
...
The documentation is hosted `on Read the Docs <https://bumpr.readthedocs.io/en/0.3.1/>`_
